...
class TestRegimeTransitionMatrix:
    ...
    def test_smoothed_priors_avoid_zero(self):
        ...
        probs = rm.transition_probs("trending_expansion")
    ...
    def test_transition_observation_updates_matrix(self):
        ...
        rm.observe("BTC", "trending_expansion")
        # Need explicit time gap simulation — use direct count manipulation
        rm._transitions["trending_expansion"]["distribution"] += 1
        probs = rm.transition_probs("trending_expansion")
    ...
    def test_most_likely_next_excludes_self(self):
        rm = RegimeTransitionMatrix()
        rm._transitions["trending_expansion"]["distribution"] = 10
        rm._transitions["trending_expansion"]["chaos"] = 2
        next_regime, prob = rm.most_likely_next("trending_expansion")
    ...
    def test_stability_score_for_persistent_regime(self):
        ...
        rm._transitions["trending_expansion"]["trending_expansion"] = 10
        rm._transitions["trending_expansion"]["distribution"] = 1
        score = rm.stability_score("trending_expansion")
        assert score > 0.5
